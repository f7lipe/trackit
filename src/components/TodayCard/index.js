...
function TodayCard() {
    return (
        <Card>
            <Container>
                <CardHeader>
                    <Title>Título do hábito</Title>
                </CardHeader>

                <Status>Sequência atual: 4 dias</Status>
                <Status>Seu recorde: 8 dias</Status>

            </Container>
            <CheckMark width="69" height="69" viewBox="0 0 69 69" xmlns="http://www.w3.org/2000/svg">
